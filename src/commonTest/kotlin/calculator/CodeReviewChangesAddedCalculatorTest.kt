...
class CodeReviewChangesAddedCalculatorTest {
  ...
  @Test fun `calculation is correct per reviewer`() {
    ...
    assertThat(valuesPerReviewer[Stubs.metrics.user1]).isEqualTo(15)
    assertThat(valuesPerReviewer[Stubs.metrics.user2]).isEqualTo(20)
    assertThat(valuesPerReviewer[Stubs.metrics.user3]).isEqualTo(10)
    assertThat(valuesPerReviewer[Stubs.metrics.user4]).isEqualTo(11)
  }
  ...
  @Test fun `calculation is correct per repository`() {
    ...
    assertThat(valuesPerRepository[repos[0]]).isEqualTo(25)
    assertThat(valuesPerRepository[repos[1]]).isEqualTo(11)
  }
