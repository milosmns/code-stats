...
class CodeReviewFeedbacksRejectedCalculatorTest {

  private val repos = listOf(Stubs.metrics.codeReviewFeedbackRepo1, Stubs.metrics.codeReviewFeedbackRepo2)
  private val calculate = { CodeReviewFeedbacksRejectedCalculator().calculate(repos) }
  ...
  @Test fun `calculation is correct per repository`() {
    ...
    assertThat(valuesPerRepository[repos[1]]).isEqualTo(1)
  }
